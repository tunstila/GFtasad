...
class SupabaseConfig {
  static const String supabaseUrl = 'https://unnlgpdvamvahbhdwmgx.supabase.co';
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVubmxncGR2YW12YWhiaGR3bWd4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY0ODE0NjEsImV4cCI6MjA5MjA1NzQ2MX0.QwZKVVUJETrXcbzQHaVkmDsL-Z-oz7YQEciYxgDywiw';
...
class SupabaseService {
  ...
  /// Upsert (insert or update on conflict) a record into a table.
  ///
  /// Useful for idempotent profile setup when an auth user already exists.
  static Future<List<Map<String, dynamic>>> upsert(
    ...
    try {
      final builder = SupabaseConfig.client.from(table).upsert(data, onConflict: onConflict);
