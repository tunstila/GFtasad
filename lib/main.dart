...
void main() async {
  ...
  final preventionMessagingService = PreventionMessagingService();
  ...
  await Future.wait([
    ...
    preventionMessagingService.initialize(),
  ]);
  ...
  runApp(MyApp(
    ...
    preventionMessagingService: preventionMessagingService,
...
class MyApp extends StatefulWidget {
  ...
  const MyApp({
    ...
    required this.preventionMessagingService,
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: widget.preventionMessagingService),
